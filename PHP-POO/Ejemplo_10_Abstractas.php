<?php   // PHP-POO/Ejemplo_10_Abstractas.php
require("errores.php");

/*  - Clases Abstractas -> página 120 manual
        - Una clase abstracta NO se puede instanciar
        - Si un método de la clase es abstracto, la clase es abstracta 
        - Todos los métodos abstractos de la clase padre 
        tienen que desarrollarse en las clases hijas */
